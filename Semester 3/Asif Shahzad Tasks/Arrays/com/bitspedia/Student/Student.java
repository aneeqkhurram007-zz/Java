...
public class Student {
    ...
    public void setPhoneNumber(int numbers) {
        phoneNumber = new PhoneNumber[numbers];
        for (int i = 0; i < phoneNumber.length; i++) {
            System.out.println("Enter your " + (i + 1) + " number: ");

            phoneNumber[i] = new PhoneNumber(input.nextInt(), input.nextInt(), input.nextInt());
    ...
    public void display() {
        ...
        for (PhoneNumber phoneNumber2 : phoneNumber) {
